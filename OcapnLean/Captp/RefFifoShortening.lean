...
-- Mild bump from the 5s default; the bmc_sat traces over the
-- strengthened state can need more SMT budget but the 60s previously
-- attempted ran the verify-veil-fresh job past its 60-min ceiling.
